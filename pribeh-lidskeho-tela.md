...
* Fenotypová plasticita. Schopnost upravovat fenotyp podle prostředí. Co člověk nepoužívá, o to přijde. Tělo se neustále snaží odhadnout optimální konstrukci pro aktuální prostředí a podle toho upravuje fenotyp.
* Osteoporóza je onemocnění, kdy se kost zhroutí. Kosti je potřeba v mládí zatěžovat, později se pak vyvinou jak silnější. Bez zátěžet tkáň neroste. Při každém pohybu nastává deformace kosti. My tyto deformace nevnímáme, ale naše buňky kostí ano.
* Vrchol vývoje kostí je u lidí mezi 20. (ženy) a 25. (muži) rokem života. Poté již kosti nerostou, naopak hmota se ztrácí. Když kosti přestanou růst, už nedojde k zesílení. Proto když se astronauti vrátí na zem, musí po přistání nosit, protože ztratili množství kostní tkáňe v kosmu, kde není gravitace, a kdyby začali kosti zatěžovat, zlomily by se.
* Osteoporózou trpí v USA ⅓ žen a 10% mužů nad 50 let. V mládí kosti málo zatěžovali, jedli málo vápníku a vitamínu D.
* Buňky, které kosti vytváří jsou osteoblasty (novou kostní tkáň vytváří) a osteoklasty (odbourávají starou kostní tkáň). Osteoblasty vydávají signál osteoklastům, aby nějakou starou tkáň odebraly. Když je však aktivita osteoklastů intenzivnější než aktivita osteblastů, vznikne osteoporóza a kostní tkáň se zmenšuje. Tento proces řídí estrogen, jeho nižší množství snižuje činnost osteoblastů a zvýší činnost osteoklastů. Stejný proces probíhá i u mužů, kteří však mají estrogenu výrazně méně.
